      ...
      {std::string("newtab"),
       {
           ...
           {"cryptoDotComWidgetDesc",
            IDS_BRAVE_NEW_TAB_CRYPTO_DOT_COM_WIDGET_DESC},  // NOLINT
#endif
           ...
           {"rewardsWidgetStartUsing",
            IDS_REWARDS_WIDGET_START_USING},  // NOLINT
           // Together Widget
...
#endif
#if BUILDFLAG(CRYPTO_DOT_COM_ENABLED)
           {"cryptoDotComWidgetShowPrice",
            IDS_CRYPTO_DOT_COM_WIDGET_SHOW_PRICE},
           ...
           {"cryptoDotComWidgetViewMarkets",
            IDS_CRYPTO_DOT_COM_WIDGET_VIEW_MARKETS},  // NOLINT
      ...
      {std::string("rewards"),
       {
           ...
           {"onboardingStartUsingRewards",
            IDS_BRAVE_REWARDS_ONBOARDING_START_USING_REWARDS},  // NOLINT
           ...
           {"upholdPromoEquitiesTitle",
            IDS_BRAVE_UI_UPHOLD_PROMO_EQUITIES_TITLE},  // NOLINT
          ...
          }},
      {
          ...
          std::string("tip"),
          {
              ...
              {"cancelConfirmationText",
               IDS_BRAVE_REWARDS_TIP_CANCEL_CONFIRMATION_TEXT},  // NOLINT
              {"cancelMonthlyContribution",
               IDS_BRAVE_REWARDS_TIP_CANCEL_MONTHLY_CONTRIBUTION},  // NOLINT
              {"changeAmount", IDS_BRAVE_REWARDS_TIP_CHANGE_AMOUNT},
              {"confirmCancel", IDS_BRAVE_REWARDS_TIP_CONFIRM_CANCEL},
              {"contributionAmount",
               IDS_BRAVE_REWARDS_TIP_CONTRIBUTION_AMOUNT},  // NOLINT
              {"contributionCanceled",
               IDS_BRAVE_REWARDS_TIP_CONTRIBUTION_CANCELED},  // NOLINT
              {"currentlySupporting",
               IDS_BRAVE_REWARDS_TIP_CURRENTLY_SUPPORTING},
              {"currentMonthlyContribution",
               IDS_BRAVE_REWARDS_TIP_CURRENT_MONTHLY_CONTRIBUTION},  // NOLINT
              {"doMonthly", IDS_BRAVE_UI_DO_MONTHLY},
              {"errorHasOccurred", IDS_BRAVE_REWARDS_TIP_ERROR_HAS_OCCURRED},
              {"errorServerConnection",
               IDS_BRAVE_REWARDS_TIP_ERROR_SERVER_CONNECTION},  // NOLINT
              ...
              {"monthlyContributionSet",
               IDS_BRAVE_REWARDS_TIP_MONTHLY_CONTRIBUTION_SET},  // NOLINT
              {"monthlyText", IDS_BRAVE_UI_MONTHLY_TEXT},
              {"nextContributionDate",
               IDS_BRAVE_REWARDS_TIP_NEXT_CONTRIBUTION_DATE},  // NOLINT
              {"notEnoughTokens", IDS_BRAVE_UI_NOT_ENOUGH_TOKENS},
              {"notEnoughTokensLink", IDS_BRAVE_UI_NOT_ENOUGH_TOKENS_LINK},
              {"on", IDS_BRAVE_UI_ON},
              {"onboardingMaybeLater",
               IDS_BRAVE_REWARDS_ONBOARDING_MAYBE_LATER},
              {"onboardingStartUsingRewards",
               IDS_BRAVE_REWARDS_ONBOARDING_START_USING_REWARDS},  // NOLINT
              {"onboardingTerms", IDS_BRAVE_REWARDS_ONBOARDING_TERMS},
              {"onboardingTipHeader", IDS_BRAVE_REWARDS_ONBOARDING_TIP_HEADER},
              ...
              {"supportThisCreator",
               IDS_BRAVE_REWARDS_TIP_SUPPORT_THIS_CREATOR},
              {"termsOfService", IDS_BRAVE_REWARDS_TIP_TERMS_OF_SERVICE},
              {"thanksForTheSupport",
               IDS_BRAVE_REWARDS_TIP_THANKS_FOR_THE_SUPPORT},  // NOLINT
      ...
      {std::string("rewards-internals"),
       {
           ...
           {"mainDisclaimer",
            IDS_BRAVE_REWARDS_INTERNALS_MAIN_DISCLAIMER},  // NOLINT
           {"rewardsTypeAuto",
