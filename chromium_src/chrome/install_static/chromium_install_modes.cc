/* Copyright (c) 2019 The XFII Authors. All rights reserved.
 * This Source Code Form is subject to the terms of the Mozilla Public
 * License, v. 2.0. If a copy of the MPL was not distributed with this file,
 * You can obtain one at http://mozilla.org/MPL/2.0/. */

// Brand-specific constants and install modes for XFII.
...
const InstallConstants kInstallModes[] = {
    // The primary install mode for stable XFII.
    {
        ...
        L"XFII",                           // A distinct base_app_name.
        L"XFII",                           // A distinct base_app_id.
        L"BraveHTML",                              // ProgID prefix.
        L"XFII HTML Document",                    // ProgID description.
    ...
    // A secondary install mode for XFII Beta
    {
        sizeof(kInstallModes[0]),
        ...
        L"XFII Beta",                      // A distinct base_app_name.
        L"BraveBeta",                              // A distinct base_app_id.
        L"BraveBHTML",                             // ProgID prefix.
        L"XFII Beta HTML Document",               // ProgID description.
    ...
    // A secondary install mode for XFII Dev
    {
        sizeof(kInstallModes[0]),
        ...
        L"XFII Dev",                       // A distinct base_app_name.
        L"BraveDev",                               // A distinct base_app_id.
        L"BraveDHTML",                             // ProgID prefix.
        L"XFII Dev HTML Document",                // ProgID description.
    ...
    // A secondary install mode for XFII SxS (canary).
    {
        sizeof(kInstallModes[0]),
        ...
        L"XFII Nightly",                    // A distinct base_app_name.
        L"BraveNightly",                            // A distinct base_app_id.
        L"BraveSSHTM",                             // ProgID prefix.
        L"XFII Nightly HTML Document",             // ProgID description.
...
#else
const InstallConstants kInstallModes[] = {
    // The primary (and only) install mode for XFII developer build.
    {
        sizeof(kInstallModes[0]),
        ...
        L"",              // Empty install_suffix for the primary install mode.
        L"",              // No logo suffix for the primary install mode.
        L"",            // Empty app_guid since no integraion with XFII Update.
        L"XFII Development",  // A distinct base_app_name.
        L"BraveDevelopment",   // A distinct base_app_id.
        L"BraveDevHTM",                             // ProgID prefix.
        L"XFII Development HTML Document",           // ProgID description.
