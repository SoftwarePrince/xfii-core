...
const locale: Record<string, string> = {
  ...
  rewardsWidgetBraveRewards: 'XFII',
  ...
  rewardsWidgetAboutRewards: '$1Learn more$2 about XFII',
  rewardsWidgetTurnOnAds: 'XFII ',
