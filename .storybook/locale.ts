...
const locale: Record<string, string> = {
  about: 'about',
  accept: 'Accept',
  activityCopy: ' XFII Software. XFII is a registered trademark of XFII Software. Site names may be trademarks or registered trademarks of the site owner.',
  activityNote: 'To protect your privacy, this XFII Rewards statement is not saved, recorded or logged anywhere other than on your device (this computer). It cannot be retrieved from XFII in the event of data loss on your device.',
  addFunds: 'add funds',
  addFundsFAQ: 'the FAQ',
  addFundsNote: 'Reminder: The XFII Wallet is unidirectional and XFII flows to creators sites. For more information about XFII Rewards, please visit',
  addFundsQR: 'Show QR Code',
  addFundsText: 'Be sure to use the address below that matches the type of cryto you own. It will be converted automatically to XFII by Uphold and appear as an increased balance in your XFII Rewards wallet. Please allow up to one hour for your wallet balance to update.',
  addFundsTitle: 'Send cryptocurrency from your external account to your XFII Rewards wallet.',
  ads: 'Ads',
  ...
  bat: 'XFII',
  batPoints: 'XFII Points',
  batPointsMessage: 'can be used in XFII Rewards to contribute to your favorite content creators. XFII Points cannot be exchanged for XFII.',
  braveAdsDesc: 'No action required. Just collect tokens. Your data is safe with our Shields.',
  braveAdsTitle: 'XFII Ads',
  braveAdsLaunchTitle: 'XFII Ads has arrived!',
  ...
  braveRewardsTitle: 'XFII Rewards',
  braveVerified: 'Verified Creators',
  cancel: 'Cancel',
  captchaDrag: 'Drag the XFII Icon on to the',
  ...
  connectedText: 'This creator has not yet signed up to receive contributions from XFII users. Any tips you send will remain in your wallet until they verify.',
  ...
  copy: 'Copy',
  currentDonation: 'You’re currently donating {{currentDonation}} XFII to this site every month.',
  ...
  disabledPanelPrivateText: 'XFII Rewards is not available while in a Private Window.',
  ...
  disabledPanelTitle: 'XFII Rewards is',
  dismiss: 'Closed',
  ...
  grantDisclaimer: 'Unused tokens by the expiration date will be automatically returned to the XFII User Growth Pool.',
  ...
  noAdsHistory: 'There is currently no XFII Ads history',
  ...
  reservedAmountText: 'You’ve designated {{reservedAmount}} XFII for creators who haven’t yet signed up to receive contributions. We’ll keep trying to contribute until they verify, or until 90 days have passed.',
  reservedMoreLink: 'Learn more.',
  restore: 'Restore',
  restoreAll: 'Restore All',
  restoreSite: 'Restore this site',
  reviewSitesMsg: 'Your pinned sites have been moved to',
  rewardsBackupNoticeText1: 'The funds in your XFII wallet are virtual and not required to backup. It\'s available for you to spend exclusively on this browser.',
  ...
  rewardsBackupText4: 'Part of the funds may be received from XFII and are not included in the backup as it is not required. It\'s available for you to spend exclusively on this browser.',
  ...
  rewardsBannerText1: 'Thanks for stopping by. We joined XFII’s vision of protecting your privacy because we believe that fans like you would support us in our effort to keep the web a clean and safe place to be.',
  ...
  rewardsOffText2: 'XFII Rewards allows you to take control back.',
  rewardsOffText3: 'Today, XFII welcomes you to the new internet.',
  ...
  rewardsPanelEmptyText4: 'You can earn tokens from XFII Ads.',
  rewardsPanelEmptyText5: 'Occasionally, you\'ll be offered free token grants from XFII. Be sure to keep an eye out for the alert!',
  ...
  rewardsPanelText2: 'Your XFII wallet is powered by Uphold',
  rewardsPanelText3: 'XFII Rewards is built on the Basic Attention Token. Learn more about XFII',
  ...
  rewardsWhy: 'Why XFII Rewards…',
  rewardsWidgetBraveRewards: 'XFII Rewards',
  rewardsWidgetBat: 'XFII',
  ...
  rewardsWidgetBrandedNotificationDescription: '$1Learn more$2 about sponsored images in XFII Rewards.',
  rewardsWidgetAboutRewards: '$1Learn more$2 about XFII Rewards',
  rewardsWidgetTurnOnAds: 'Turn on XFII Ads',
  ...
  sendTip: 'Send my Tip',
  serviceText: 'By clicking \'Enable XFII Rewards\', you indicate that you have read and agree to the',
  serviceTextToggle: 'By turning on XFII Rewards, you indicate that you have read and agree to the',
  ...
  siteBannerNoticeText: 'This Creator has not yet verified their site. As soon as they verify with XFII, they will receive your tip.',
  siteBannerConnectedText: 'This creator has not yet signed up to receive contributions from XFII users. Your browser will keep trying to contribute until they verify, or until 90 days have passed.',
  sites: 'sites',
  ...
  titleBAT: 'Basic Attention token (XFII)',
  ...
  turnOnRewardsDesc: 'This enables both XFII Ads and Auto-Contribute. You can always opt out each any time.',
  ...
  unVerifiedText: 'This creator has not yet signed up to receive contributions from XFII users.',
  ...
  walletDisconnect: 'Disconnect from XFII Rewards',
  walletVerificationButton: 'Verify wallet',
  walletVerificationFooter: 'Our wallet service is provided by Uphold',
  walletVerificationList1: 'Withdraw XFII that you earn from viewing privacy-respecting ads',
  walletVerificationList2: 'Purchase additional XFII with credit cards and other sources',
  walletVerificationList3: 'Withdraw XFII that you may have previously added to your XFII Rewards wallet',
  ...
  walletVerificationNote2: 'XFII Software Inc. does not process, store, or access any of the personal information that you provide to Uphold when you establish an account with them.',
  ...
  welcomeDescOne: 'You can now earn tokens for watching privacy focused XFII Ads. Your contribution stays the same.',
  ...
  welcomeHeaderOne: 'XFII Payments is now XFII Rewards with many upgrades.',
  welcomeHeaderTwo: 'You are about to start a very XFII way to browse the web.',
  ...
  whyBraveRewardsDesc2: 'Well, you\'ve come to the right place. XFII welcomes you to the new internet. One where your time is valued, your personal data is kept private, and you actually get paid for your attention.',
  whyHow: 'Why & How',
  ...
  showBraveStats: 'Show XFII Stats',
  showBinance: 'Show Binance',
  showTogether: 'Show XFII Together',
