...
/**
 * Perform an update in settings both in xfii://settings and Shields store whenever a setting change.
...
/**
 * Get a list of settings values from xfii://settings and update if comparison
